...
\begin{document}
	...
	\begin{picture}(12,8)
		\put(2,0.3){\line(1,0){4}}
		\put(2,1.5){\line(1,0){4}}
		\put(2,6){\line(1,0){4}}
		\put(3.5,6){\vector(0,-1){4.5}}
		\put(5.5,6){\vector(0,-1){5.7}}
		\put(3,3.6){$\alpha$}
		\put(5.2,3.6){$\beta$}
		\put(6.5,5.8){upper state}
		\put(6.5,1.5){lower state 1}
		\put(6.5,0.2){lower state 2}
	\end{picture}
